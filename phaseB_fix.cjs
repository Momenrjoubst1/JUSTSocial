...
for (const filePath of filesToProcess) {
    ...
    asyncFunctions.reverse(); for (const func of asyncFunctions) {
        if (func.wasForgotten()) continue; if (func.getDescendantsOfKind(SyntaxKind.TryStatement).length > 0) continue;
