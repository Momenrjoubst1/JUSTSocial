...
### 1️⃣ اختبر المفاتيح
```bash
python tools/agents/test_keys.py
```
...
- راجع `docs/agents/TESTING_GUIDE.md` للمساعدة
...
**إذا ظهرت أخطاء:**
- تحقق من الـ logs
- راجع `docs/agents/TESTING_GUIDE.md` قسم "استكشاف الأخطاء"
...
| `docs/agents/TESTING_GUIDE.md` | دليل الاختبار الشامل |
...
- [ ] Python >= 3.10 مثبت
- [ ] المكتبات مثبتة (`pip install -r backend/agents/requirements.txt`)
- [ ] `.env.local` موجود وممتلئ
- [ ] `tools/agents/test_keys.py` نجح
