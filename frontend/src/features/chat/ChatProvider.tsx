...
export function ChatProvider({ children }: { children: ReactNode }) {
        ...
        const fetchInbox = async () => {
            ...
            if (data && !error) {
                const mapped: Contact[] = data.map((row: any) => ({
                    ...
                    name: row.other_user_name || i18n.t('common:user'),
                    ...
                    time: row.last_message_time ? new Date(row.last_message_time).toLocaleTimeString(i18n.language, { hour: '2-digit', minute: '2-digit' }) : '',
    ...
    const handleIncomingMessage = React.useCallback(async (payload: any) => {
        ...
        let senderNameForToast = i18n.t('chat:someone');
            ...
            if (contact) {
                ...
                if (isInsert || msgTime >= contactTime) {
                    const updatedContact = {
                        ...
                        time: new Date(newMsg.created_at).toLocaleTimeString(i18n.language, { hour: '2-digit', minute: '2-digit' }),
