...
export const MediaGallery: React.FC<MediaGalleryProps> = ({ conversationId, isOpen, onClose }) => {
    ...
    const filters = [
        { key: 'all' as const, label: t('filterAll'), icon: <Grid3X3 size={14} />, count: items.length },
        { key: 'image' as const, label: t('filterPhotos'), icon: <Camera size={14} />, count: imageCount },
        { key: 'audio' as const, label: t('filterAudio'), icon: <Mic size={14} />, count: audioCount },
    ];
