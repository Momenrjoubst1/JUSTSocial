...
async def main():
    # Setup CLI arguments
    parser = argparse.ArgumentParser(description="Call GitHub Models API")
    parser.add_argument("message", nargs="?", default="Hello GPT-4o! Tell me a fun fact.", help="The message to send")
