                    ...
                    <div className="max-w-[90vw] max-h-[85vh] flex items-center justify-center" onClick={(e) => e.stopPropagation()}>
                        ...
                        {isLoading && (
                            ...
                            >
                                ...
                                <p className="text-white/30 text-xs font-medium">Decrypting media...</p>
                                <style>{`
                                    @keyframes shimmer {
                        ...
                        {error && (
                            ...
                            >
                                ...
                                <div className="text-center">
                                    <p className="text-red-400 text-sm font-bold mb-1">Decryption Failed</p>
                                    <p className="text-white/30 text-xs">This media could not be decrypted</p>
                                </div>
                            </motion.div>
                        )}
