    ...
    <div ref={featurePanelRef} style={{ position: 'absolute', top: 12, right: 12, zIndex: 16 }}>
      ...
      <div style={{
        ...
        <button
          ...
          title={screenShare.isScreenSharing ? "Stop Screen Sharing" : String(t("videochat.shareScreen"))}
        >
        ...
        <button
          ...
          title={agentActive ? "Stop AI Agent" : "Start AI Agent"}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={styles.hoverBtnIcon}>
        ...
        <button
          ...
          title={!connected ? "Requires a partner" : (isWatchMode ? "Close watch mode" : "Watch together")}
        >
          <svg viewBox="0 0 24 24" fill="currentColor" style={styles.hoverBtnIcon}>
        ...
        <button
          ...
          title={!connected ? "Requires a partner" : (isCodeMode ? "Close code editor" : "Open code editor")}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={styles.hoverBtnIcon}>
        ...
        <button
          ...
          title={!connected ? "Requires a partner" : (isWhiteboardMode ? "Close whiteboard" : "Whiteboard")}
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={styles.hoverBtnIcon}>
        ...
        <button
          ...
          title={!connected ? "Requires a partner" : (isChessMode ? "Close chess" : "Open chess")}
        >
        ...
        <LockedFeatureBtn
          ...
          title="Avatar — Under Development"
